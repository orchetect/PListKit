...
/// This is the most common plist root layout and provides the most amount of useful abstractions of
/// all plist classes in PListKit.
///
...
extension DictionaryPList {
    ...
    /// When set to `true`, all `[dict:]` subscript usage will take on `[dictCreate:]`
    /// functionality.
...
extension DictionaryPList {
    /// Instantiate a `DictionaryPList` object by populating its contents using an existing
    /// dictionary.
    ///
    /// - parameters:
