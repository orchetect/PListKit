...
class DataTests: XCTestCase {
    ...
    func testSubscript_Array() {
        ...
        XCTAssertTrue(pl.storage[array: "TestArray"]!
    ...
    func testPListRawArray_convertedToPListArray() {
        ...
        let array: PList.RawArray = ["A key" as NSString,
                                     123 as NSNumber]
    ...
    func testPListNode() throws {
        ...
        XCTAssertEqual(pl.root.array(key: "TestArray") .value?[0] as? String,
                       "String value in the array")
        XCTAssertEqual(pl.root.array(key: "TestArray") .value?[1] as? Int,
                       999)
        XCTAssertEqual(pl.root.bool(key: "TestBool").value,
                       true)
        XCTAssertEqual(pl.root.data(key: "TestData").value,
                       Data([0x00, 0xFF]))
        XCTAssertEqual(pl.root.date(key: "TestDate").value,
                       Date(timeIntervalSince1970: 1527904054.0))
        ...
        XCTAssertEqual(pl.root
                        ...
                        .value,
                       "A dict string value")
        XCTAssertEqual(pl.root.double(key: "TestDouble").value,
                       456.789)
        XCTAssertEqual(pl.root.int(key: "TestInt")   .value,
                       234)
        XCTAssertEqual(pl.root.string(key: "TestString").value,
                       "A string value")
    ...
    func testPListNode_ArrayMutation() throws {
        ...
        XCTAssertEqual(pl.root.array(key: "TestArray").value?[2] as? String,
                       "appended item")
    ...
    func testPListNode_StoringPListNodeObjects() throws {
        ...
        XCTAssertEqual(root.array(key: "TestArray").value?[string: 0],
                       "String value in the array")
        XCTAssertEqual(root.array(key: "TestArray").value?[int: 1],
                       999)
        XCTAssertEqual(root.bool(key: "TestBool").value,
                       true)
        XCTAssertEqual(root.data(key: "TestData").value,
                       Data([0x00, 0xFF]))
        XCTAssertEqual(root.date(key: "TestDate").value,
                       Date(timeIntervalSince1970: 1527904054.0))
        XCTAssertEqual(root
                        .dict(key: "TestDict")
                        .int(key: "DictInt")
        ...
        XCTAssertEqual(root
                        ...
                        .value,
                       "A dict string value")
        XCTAssertEqual(root.double(key: "TestDouble").value,
                       456.789)
        XCTAssertEqual(root.int(key: "TestInt").value,
                       234)
        XCTAssertEqual(root.string(key: "TestString").value,
                       "A string value")
